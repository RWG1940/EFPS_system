...
public class EmpServiceImpl extends ServiceImpl<EmpMapper, Emp> implements EmpService {
  ...
  public ResultResponse loginByToken() {
    ...
    if (userDetails != null) {
      ...
      redisTemplate
          .opsForValue()
          .set(empMapper.getEmp(new Emp(userDetails.getUsername())).geteUsername(), 1);
      // WebSocketServer.getInstance().sendToAll(new WebSocketMessage(1, 1, "有人登录啦",
      // empMapper.getEmp(new Emp(userDetails.getUsername())).geteId(),
  ...
  public ResultResponse logout() {
    ...
    if (userDetails != null) {
      ...
      redisTemplate
          .opsForValue()
          .set(empMapper.getEmp(new Emp(userDetails.getUsername())).geteId(), 0);
    }
